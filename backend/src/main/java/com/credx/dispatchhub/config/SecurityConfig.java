    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // user at the security-filter level; fine-grained ownership checks
                        // (rider owns this trip / driver assigned to this trip) are enforced
                        // in TripController/TripService instead - see the trip endpoints
                        // below for where that is (and isn't) done consistently.
